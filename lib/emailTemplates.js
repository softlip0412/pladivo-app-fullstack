                    ...
                    <div style="flex: 2;">
                      ...
                      <div style="background: white; padding: 15px; border-radius: 6px; border: 1px solid #dee2e6;">
                        <div style="margin-bottom: 8px;">
                          ...
                          <strong style="margin-left: 10px;">${process.env.SEPAY_BANK_CODE || 'TPB'} - TPBank</strong>
                        </div>
                        <div style="margin-bottom: 8px;">
                          <span style="color: #666; font-size: 13px;">Số tài khoản:</span>
                          <strong style="margin-left: 10px;">${process.env.SEPAY_ACCOUNT_NUMBER || '00002456029'}</strong>
                        </div>
                        <div style="margin-bottom: 8px;">
