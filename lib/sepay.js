...
export function getSepayAccountInfo() {
  return {
    accountNumber: process.env.SEPAY_ACCOUNT_NUMBER || process.env.NEXT_PUBLIC_SEPAY_ACCOUNT_NUMBER || '0123456789',
    accountName: process.env.SEPAY_ACCOUNT_NAME || process.env.NEXT_PUBLIC_SEPAY_ACCOUNT_NAME || 'CONG TY PLADIVO',
    bankName: process.env.SEPAY_BANK_NAME || process.env.NEXT_PUBLIC_SEPAY_BANK_NAME || 'Vietcombank',
    bankCode: process.env.SEPAY_BANK_CODE || process.env.NEXT_PUBLIC_SEPAY_BANK_CODE || 'VCB',
  };
}
