...
const EditDialog = ({ open, setOpen, blog, onSuccess }) => {
  ...
  useEffect(() => {
    if (open && blog) {
      ...
      setCoverImageUrl(blog.coverImage?.url || "");
      setCoverImageAlt(blog.coverImage?.alt || "");
          ...
          <DialogFooter className="border-t pt-4">
            <div className="flex justify-end gap-2 w-full">
              ...
              <Button type="submit" disabled={updating}>
                {updating ? "Đang cập nhật..." : "Cập nhật bài viết"}
              </Button>
            </div>
          </DialogFooter>
        </form>
